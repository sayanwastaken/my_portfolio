  ...
  const projects = [
    {
      ...
      project_desc:
        "An online stocks trading web app. Built using EJS, Express js, Node js and MongoDB.",
    ...
    },
    {
      ...
      project_desc:
        "SnapDeal is an Indian eCommerce products-marketplace.Built using HTML, CSS and JS. ",
